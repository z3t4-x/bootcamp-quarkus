...
public class Catalogos {
	...
	public String getItMatenible() {
		return this.itMatenible;
	}

	public void setItMatenible(String itMatenible) {
		this.itMatenible = itMatenible;
	}

	@Override
	public String toString() {
		return "Catalogos [idCatalogo=" + this.idCatalogo + ", dsNombre=" + this.dsNombre + ", tlDescripcion=" + this.tlDescripcion
				+ ", itMatenible=" + this.itMatenible + "]";
	}
